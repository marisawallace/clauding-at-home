...
- **Analytics**: `cs --stats` for a breakdown of your whole archive — provider/host split, monthly timeline, hour-of-day and weekday activity, busiest day, top Claude Code directories
